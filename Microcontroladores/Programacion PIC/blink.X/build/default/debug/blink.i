...
; CONFIG3
  ...
  CONFIG WDTE = ON ; WDT operating mode (WDT enabled regardless of sleep; ((WDTCON0) and 07Fh), 0 ignored)
...
START:
    MOVLW 00000000B ; Apagar LED en ((PORTA) and 07Fh), 3
    MOVWF PORTA

    CALL Retardo ; Llamar al retardo

    MOVLW 11111111B ; Encender LED en ((PORTA) and 07Fh), 3
    MOVWF PORTA
