# Function to standardize S-parameter plotting so all plots look consistent

import matplotlib.pyplot as plt
import numpy as np

def plot_s_parameters(network, title='S-Parameter Analysis', save_fig=False, autoscales=False):
    ...
    # -----------------------------------------------------------------------------
    # Plot 1: Transfers (S21 and S31) - Scale: -3.4 dB to -2.9 dB
    # -----------------------------------------------------------------------------
    ax1.set_title('Transfers', fontweight='bold')
    ...
    # -----------------------------------------------------------------------------
    # Plot 2: Return Loss (S11, S22, S33) - Scale: -15 dB to -35 dB
    # -----------------------------------------------------------------------------
    ax2.set_title('Return Loss', fontweight='bold')
    ...
    # -----------------------------------------------------------------------------
    # Plot 3: Isolation (S23) - Scale: -45 dB to 5 dB
    # -----------------------------------------------------------------------------
    ax3.set_title('Isolation ($S_{23}$)', fontweight='bold')
